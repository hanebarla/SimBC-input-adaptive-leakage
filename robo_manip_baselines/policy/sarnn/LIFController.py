"""Input-adaptive leakage controllers."""
...
class RuleBaseController:
    """Map the normalized frame difference to a leakage coefficient."""
    ...
    def get_new_param(self, image: torch.Tensor) -> float:
        """Retain the reference implementation's method name."""
    ...
    def __repr__(self) -> str:
        return f"RuleBaseController(k={self.k}, threshold={self.threshold})"
